...
public class AccountPickerActivity extends AppCompatActivity {
    ...
    private void showPicker() {
        ...
        // Build display names — mark the default account
        ...
        new AlertDialog.Builder(this)
            ...
            .setPositiveButton("Open YouTube", (d, w) -> {
                String chosenName =
                    finalAccounts[selected[0]].name;

                // Save as temp selection (shown in status)
                prefs.edit()
            ...
            // If they just tap back/outside = use default
    ...
    private void openYouTube() {
        // Launch YouTube — account switching guide shown via toast
        ...
        try {
            ...
            // YouTube not installed — open Play Store
